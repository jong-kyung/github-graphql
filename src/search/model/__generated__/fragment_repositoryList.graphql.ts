/**
 * @generated SignedSource<<a3b8db80ba827c8dbfc784793171f831>>
...
export type fragment_repositoryList$data = {
  readonly search: {
  ...
  readonly " $fragmentType": "fragment_repositoryList";
};
export type fragment_repositoryList$key = {
  readonly " $data"?: fragment_repositoryList$data;
