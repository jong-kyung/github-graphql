...
export type useRepositoryQuery$variables = {
  query: string;
};
export type useRepositoryQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"fragment_repositoryList">;
};
export type useRepositoryQuery = {
  response: useRepositoryQuery$data;
  variables: useRepositoryQuery$variables;
};
...
(node as any).hash = "3dcf1d5cf1403ebabf184312f8a44078";
